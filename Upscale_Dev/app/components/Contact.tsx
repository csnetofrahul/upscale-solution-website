  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSubmitStatus('There was an error sending your message. Please try again or contact us directly.');
      }
    } catch (error) {
      setSubmitStatus('There was an error sending your message. Please try again or contact us directly.');
    } finally {
              ...
              <div className="grid gap-6">
                ...
                <div className="flex items-center gap-4 p-6 rounded-2xl bg-gradient-to-r from-gray-800/30 to-gray-900/30 border border-gray-700/30 hover:border-cyan-500/50 transition-all duration-300 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">hello@upscalesolution.com</p>
                  </div>
                </div>
              </div>
