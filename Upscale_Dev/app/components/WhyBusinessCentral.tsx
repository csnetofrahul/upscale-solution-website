...
export default function WhyBusinessCentral() {
  ...
  const features = [
    ...
    },
    {
      ...
      image: 'https://readdy.ai/api/search-image?query=Professional%20project%20management%20dashboard%20interface%20showing%20cost%20tracking%20and%20resource%20allocation%20charts%2C%20modern%20business%20software%20design%20with%20clean%20blue%20and%20white%20interface%2C%20financial%20graphs%20and%20project%20timeline%20visualization%2C%20professional%20corporate%20software%20aesthetic&width=320&height=240&seq=project-costing&orientation=landscape'
    },
    {
      icon: 'ri-cloud-line',
